...
\def\ps@plain{
  ...
  \def\@oddfoot{
    \raisebox{4mm}{\hbox to 0pt{\small Last Update: \textbf{December, 2025}\hss}\hbox to\textwidth{\hfill\thepage\hfill}}
}
...
Authors: Mehdi Karami*, Dr. Betsabeh Tanoori \hfill *Corresponding author, Manuscript in preparation \\
...
\begin{itemize}[label={\customsquare}]
    ...
    \item Contributed to the implementation of \textbf{Unit Testing}, leveraging \textbf{BDD} to ensure robust and reliable code across projects.
    \item Developed comprehensive \textbf{documentation} using \textbf{Confluence} and \textbf{Xcode DocC}, for both \textbf{QA} and \textbf{iOS} teams.
...
% \begin{tabularx}{\textwidth}{@{}X@{\hspace{5mm}}X@{}}
%     \customsquare\hspace{2mm}\href{https://github.com/karami-mehdi/CyberattackDetection}{\underline{\textbf{Cyberattack Detection and Analysis}}} & 
%     \customsquare\hspace{2mm}\href{https://github.com/karami-mehdi/SolarPowerGenerationAnalysis}{\underline{\textbf{Solar Power Generation Prediction}}} \\
%     \vspace{-1mm}
%     \customsquare\hspace{2mm}\href{https://github.com/AINexumLab/NexumAI}{\underline{\textbf{NexumAI}}} &
%     \vspace{-1mm}
%     \customsquare\hspace{2mm}\href{https://github.com/karami-mehdi/AISightQuest}{\underline{\textbf{AI Sight Quest}}} \\
%     \vspace{-1mm}
%     \customsquare\hspace{2mm}\href{https://github.com/karami-mehdi/TodayILearned/tree/main/DataMining}{\underline{\textbf{Numeric Prediction}}} &
%     \vspace{-1mm}
%     \customsquare\hspace{2mm}\href{https://github.com/karami-mehdi/Heart-Pulse-Detector-Using-Arduino}{\underline{\textbf{Arduino Heart Rate Monitor (BPM Counter)}}} \\
%     \vspace{-1mm}
%     \customsquare\hspace{2mm}\href{https://github.com/karami-mehdi/TodayILearned/blob/main/ComputationalIntelligence/CharacterClassificationUsingPerceptron.ipynb}{\underline{\textbf{Character Classification Using Perceptron}}} &
%     \vspace{-1mm}
%     \customsquare\hspace{2mm}\href{https://github.com/karami-mehdi/TodayILearned/blob/main/InformationRetrieval/information-retrieval.ipynb}{\underline{\textbf{Information Retrieval}}}
% \end{tabularx}
...
\hbox{\quad Stack: NLTK, inflect}}

\vspace{4mm}
\hspace{-6mm} \small \textbf{Additional projects can be found at: \href{https://github.com/karami-mehdi}{\underline{GitHub account}}.}
...
K. N. Toosi University of Technology \hfill Tehran, Iran \\ [5pt]
\textbf{Contributor and participant in proposals on \href{https://github.com/swiftlang/swift-evolution}{\underline{\textbf{Swift Evolution GitHub Repository}}}} \hfill Since Dec 2023
