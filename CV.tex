...
\begin{itemize}[label={\customsquare}]
    ...
    \begin{itemize}
        ...
        \item Stack: Machine Learning, BERT Model, Swift, SwiftUI, SwiftData, MVVM, \mbox{Vision} Framework, Speech Framework, TipKit, …
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Stack: Swift, SwiftUI, MVVM, Firebase Auth/Database, UIViewRepresentable, Reactive Programming, Combine, Swift Package Manager, Lottie Json, Figma, UserDefaults, …
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Stack: Swift, Protocol-Oriented Programming, Clean Architecture, Result Builder, Command-line Interface, …
    \end{itemize}
\end{itemize}
