...
\def\ps@plain{
  ...
  \def\@oddfoot{\hbox to 0pt{\small Last Update: \textbf{March, 2025}\hss}\hbox to\textwidth{\hfill\thepage\hfill}} % Align text to left and page number to center
...
\textbf{\huge \name} \hfill \href{mailto:\email}{\underline{\small \faEnvelope\ \email}} \hfill \href{tel:\phone}{\underline{\small \faPhone\ \phone}} \\
{\small \faLocationArrow\ Shiraz, Iran} \hfill \hfill \href{https://github.com/karami-mehdi}{\underline{\small \faGithub\ github.com/karami-mehdi}} \hfill \href{https://www.linkedin.com/in/karami-mehdi}{\underline{\small \faLinkedin\ linkedin.com/in/karami-mehdi}}\\ % LinkedIn profile
\end{tabular}
\end{center}
...
%-----------------EDUCATION-----------------
\section*{Education}
\textbf{Bachelor of Computer Engineering} - GPA: 3.50 (out of 4) \hfill Sep 2021 - Expected Jul 2025 \\
...
Machine learning & Bioinformatics & Computational Neuroscience \\
Algorithm Design & Programming Language Theory & Compiler Design
\end{tabularx}
...
Swimming & Playing Violin & Traveling \\
Cooking International Cuisine & Esports Gaming (LOL) & Watching Movies
\end{tabularx}
